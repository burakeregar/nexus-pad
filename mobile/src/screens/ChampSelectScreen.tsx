                        ...
                        <View style={styles.header}>
                            <View style={styles.headerTop}>
                                ...
                                <View style={styles.timerContainer}>
                                    <View style={[styles.timerRing, timeLeft <= 5 && styles.timerRingCritical]}>
                                            ...
                                            <View
                                                ...
                                                style={[
                                                    styles.timerSegment,
                                                    {
                                                        ...
                                                        opacity: i < Math.ceil((timeLeft / 30) * 12) ? 1 : 0.15,
                                                        backgroundColor: timeLeft <= 5 ? '#EF4444' : '#3EE0C1',
                                                    },
                                                ]}
                                            />
                                        ))}
                                        <Text style={[styles.timerText, timeLeft <= 5 && styles.timerTextCritical]}>
                                            {timeLeft}
                                        </Text>
                                    </View>
                                </View>
                                {/* Title and Phase - Reduced emphasis */}
                                <View style={styles.headerTitleContainer}>
                                    <Text style={styles.headerTitle}>
                                        {selectionMode === 'ban' ? 'BAN A CHAMPION' : 'CHOOSE YOUR CHAMPION'}
                                    </Text>
                                    <Text style={styles.phaseLabel}>
                                        {selectionMode === 'ban' ? 'Ban Phase' : selectionMode === 'planning' ? 'Planning Phase' : 'Pick Phase'}
                                    </Text>
                                </View>
                            </View>
                                ...
                                return (
                                    <View key={member.cellId} style={styles.teamRow}>
                                        ...
                                        <View style={styles.teamRowLeft}>
                                            <Animated.Image
                                                source={{ uri: `https://ddragon.leagueoflegends.com/cdn/${ddragonVersion}/img/champion/${displayChampionKey}.png` }}
                                                style={[styles.championSquare, { opacity: isHovering ? hoverBlinkAnim : 1 }]}
                                            />
                                            <View>
                                                <Text style={styles.memberName} numberOfLines={1}>
                                                    {member.gameName || member.summonerName || 'Summoner'}
                                                </Text>
                                                <Text style={styles.championNameText}>
                                                    {displayChampionKey !== 'Unknown' ? displayChampionKey : 'Picking...'}
                                                </Text>
                                            </View>
                                        </View>

                                        {/* Right: Spells + Actions */}
                                ...
                                return (
                                    <View key={member.cellId || idx} style={styles.teamRow}>
                                        ...
                                        <View style={styles.teamRowLeft}>
                                            ...
                                            />
                                            <View>
                                                <Text style={[styles.memberName, { color: '#F3F5F4' }]} numberOfLines={1}>
                                                    {name}
                                                </Text>
                                                <Text style={[styles.championNameText, { color: '#8A9298' }]}>
                                                    {displayChampionKey !== 'Unknown' ? displayChampionKey : 'Picking...'}
                                                </Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.teamRowRight}>
                                            <View style={styles.rowSpells}>
                                                <View style={[styles.smallSpellIcon, { backgroundColor: 'rgba(255,255,255,0.1)' }]} />
                                                <View style={[styles.smallSpellIcon, { backgroundColor: 'rgba(255,255,255,0.1)' }]} />
                                            </View>
                                        </View>
                                    </View>
...
const styles = StyleSheet.create({
    ...
    timerRing: {
        ...
        justifyContent: 'center',
        borderWidth: 2,
        borderColor: 'rgba(62, 224, 193, 0.3)',
    },
    timerRingCritical: {
    ...
    hoveredRowBadge: {
        ...
        padding: 4,
        borderRadius: 8,
        backgroundColor: 'rgba(11,15,16,0.8)',
        borderWidth: 1,
        borderColor: '#3EE0C1',
    },
    hoveredRowIcon: {
    ...
    gridOverlay: {
        ...
        zIndex: 100,
        backgroundColor: '#0C1110', // Dark background for overlay
    },
    stickyOpenButton: {
        position: 'absolute',
        bottom: 100,
