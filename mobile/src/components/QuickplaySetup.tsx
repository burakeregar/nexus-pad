                                    ...
                                    <View style={styles.secondaryRow}>
                                        ...
                                        >
                                            {loadingSkinsFor === slot.championId ? (
                                                <ActivityIndicator size="small" color="#3EE0C1" />
                                            ) : (
...
const styles = StyleSheet.create({
    ...
    loadingText: { color: '#8A9298', marginTop: 10 },
    debugText: { color: '#ef4444', marginTop: 5, fontSize: 10 },
    ...
    header: { color: '#F3F5F4', fontSize: 20, fontWeight: 'bold', marginBottom: 20, textAlign: 'center' },
    slotsContainer: { gap: 20 },
    slotCard: { backgroundColor: '#101413', borderRadius: 12, padding: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    slotTitle: { color: '#8A9298', fontSize: 12, textTransform: 'uppercase', marginBottom: 10, fontWeight: 'bold' },
    pickRow: { flexDirection: 'row', gap: 15 },
    secondaryRow: { flexDirection: 'row', gap: 15, marginTop: 12 },
    pickButton: { flex: 1, alignItems: 'center', backgroundColor: '#0C1110', padding: 10, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
    smallButton: { paddingVertical: 8 },
    pickImage: { width: 60, height: 60, borderRadius: 30, marginBottom: 5, borderWidth: 2, borderColor: '#3EE0C1' },
    placeholder: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#1A2024', justifyContent: 'center', alignItems: 'center', marginBottom: 5, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    placeholderText: { color: '#666', fontSize: 24, fontWeight: 'bold' },
    pickLabel: { color: '#F3F5F4', fontSize: 12, fontWeight: '500' },
    secondaryLabel: { color: '#3EE0C1', fontSize: 12, marginBottom: 4, fontWeight: '700' },
    rolePlaceholder: { backgroundColor: '#1A2024' },
    ...
    modalContainer: { flex: 1, backgroundColor: '#0C1110', padding: 20 },
    modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
    modalTitle: { color: '#F3F5F4', fontSize: 20, fontWeight: 'bold' },
    emptyContainer: { alignItems: 'center', padding: 40 },
    emptyText: { color: '#F3F5F4', fontSize: 18, fontWeight: 'bold', marginBottom: 10 },
