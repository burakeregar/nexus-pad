...
const CARD_BG = 'rgba(16, 20, 19, 0.95)';
...
const styles = StyleSheet.create({
    ...
    section: {
        ...
        padding: 16,
        borderWidth: 1,
        borderColor: 'rgba(204, 255, 85, 0.2)',
    },
    sectionTitle: {
        color: ACCENT,
        fontSize: 16,
    ...
    divider: {
        height: 1,
        backgroundColor: 'rgba(204, 255, 85, 0.2)',
        marginVertical: 12,
    },
    toggleRow: {
        flexDirection: 'row',
    ...
    laneCard: {
        ...
        padding: 10,
        borderWidth: 1,
        borderColor: 'rgba(204, 255, 85, 0.15)',
    },
    laneHeader: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    emptySlot: {
        ...
        borderWidth: 1,
        borderColor: 'rgba(204, 255, 85, 0.3)',
        borderStyle: 'dashed',
        justifyContent: 'center',
        alignItems: 'center',
    },
    ...
    pickerHeader: {
        ...
        padding: 16,
        borderBottomWidth: 1,
        borderBottomColor: 'rgba(204, 255, 85, 0.2)',
    },
    pickerTitle: {
        color: ACCENT,
        fontSize: 16,
    ...
    doneButton: {
        ...
        backgroundColor: 'rgba(204, 255, 85, 0.15)',
        borderRadius: 8,
    },
    pickerClose: {
        color: ACCENT,
