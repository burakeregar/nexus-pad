                    ...
                    <View style={styles.content}>
                        ...
                        <View style={styles.textContainer}>
                            <View style={styles.titleRow}>
                                <Icon name="sword-cross" size={12} color="#3EE0C1" style={{ marginRight: 4 }} />
                            ...
                            <View style={styles.queueRow}>
                                <Icon name="gamepad-variant" size={11} color="#8A9298" style={{ marginRight: 4 }} />
                        ...
                        <View style={styles.actions}>
                            ...
                            >
                                <LinearGradient
                                    colors={['#3EE0C1', '#32B89E']}
                                    start={{ x: 0, y: 0 }}
                                    end={{ x: 0, y: 1 }}
                                    style={styles.acceptGradient}
                                >
                                    <Icon name="check" size={22} color="#0C1110" />
                                </LinearGradient>
                            </TouchableOpacity>
                        </View>
                    </View>
