...
const DEFAULT_FONT_SEMIBOLD = 'Inter_600SemiBold';
...
const theme = createTheme({
  components: {
    ...
    Button: {
      titleStyle: { fontFamily: DEFAULT_FONT_SEMIBOLD },
    },
  },
});
...
export default function App() {
  ...
  // Set global default fonts once loaded
  useEffect(() => {
    if (!fontsLoaded) return;
    Text.defaultProps ??= {};
    Text.defaultProps.style = [Text.defaultProps.style, { fontFamily: DEFAULT_FONT }];

    TextInput.defaultProps ??= {};
    TextInput.defaultProps.style = [TextInput.defaultProps.style, { fontFamily: DEFAULT_FONT }];
  }, [fontsLoaded]);
